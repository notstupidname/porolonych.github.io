...
d.classList.add("trans"),window.setTimeout(function(){window.location.href=b;console.log("250")},250))};d.addEventListener("click",function(a){for(var b=a.target;b&&b!=this;b=b.parentNode)if(b.matches("a")){E.call(b,a);break}},!1);g.addEventListener("click",function(a){for(var b=a.target;b&&b!=this;b=b.parentNode)if(b.matches("a")){E.call(b,a);break}},!1);p&&p.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();d.scrollIntoView(!0,{behavior:"smooth"})},!1);h();u();l=document.querySelector(".order");
p=document.querySelectorAll(".return-to-cart");var A=document.querySelector(".cart-cart"),B=document.querySelector(".form-wrapper");l.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();this.classList.contains("disabled")||(A.classList.add("hide"),B.classList.remove("hide"),B.classList.add("fade-in"))});l=$jscomp.makeIterator(p);for(p=l.next();!p.done;p=l.next())p.value.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();B.classList.add("hide");A.classList.remove("hide");
A.classList.add("fade-in");a=this.parentNode;if(a.classList.contains("form-success")||a.classList.contains("form-error")){var b=document.querySelector(".ajax-form");a.classList.add("hide");b.classList.remove("hide");b.classList.add("fade-in")}});var v=document.querySelector("#param_select");if(l=document.getElementById("products_list"))var C=JSON.parse(l.textContent);(l=document.querySelector(".add-to-cart"))&&l.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();if(v){a=$jscomp.makeIterator(C);
for(var b=a.next();!b.done;b=a.next())if(b=b.value,b.id==v.value){var f=b;break}}else f=C[0];0==cartApi.totalCount()&&D();cartApi.addNewItemToCart(f.id,f.title,f.price,f.url,1);h();u();var e=this;e.innerHTML="\u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u043e";window.setTimeout(function(){e.innerHTML="\u0412 \u043a\u043e\u0440\u0437\u0438\u043d\u0443"},2500,e)},!1);v&&v.addEventListener("change",function(a){a=$jscomp.makeIterator(C);for(var b=a.next();!b.done;b=a.next())if(b=b.value,b.id==v.value){document.getElementById("price").textContent=
b.price;break}},!1);if(p=document.querySelectorAll(".price-select"))for(l={},p=$jscomp.makeIterator(p),c=p.next();!c.done;l={$jscomp$loop$prop$current_select$24:l.$jscomp$loop$prop$current_select$24},c=p.next())l.$jscomp$loop$prop$current_select$24=c.value,l.$jscomp$loop$prop$current_select$24.addEventListener("change",function(a){return function(b){this.parentNode.parentNode.querySelector("span").textContent=a.$jscomp$loop$prop$current_select$24.value}}(l),!1);r.addEventListener("click",function(a){for(var b=
a.target;b&&b!=this;b=b.parentNode)if(b.matches(".minus-item, .plus-item")){a.preventDefault();a.stopPropagation();var f=b.getAttribute("data");a=b.parentNode.querySelector("input");b.classList.contains("plus-item")?a.value=cartApi.addItemToCart(f):(f=cartApi.removeItemFromCart(f),0<f?a.value=f:(b=b.parentNode.parentNode.parentNode,b.parentNode.removeChild(b)));u();break}},!1);r.addEventListener("change",function(a){for(var b=a.target;b&&b!=this;b=b.parentNode)if(b.matches(".count")){a.preventDefault();
a.stopPropagation();a=b.getAttribute("data");0<parseInt(b.value)?cartApi.setCountForItem(a,parseInt(b.value)):(b=b.parentNode.parentNode.parentNode,b.parentNode.removeChild(b),cartApi.removeItemFromCartAll(a));u();break}},!1);document.querySelector(".ajax-form").addEventListener("submit",function(a){a.preventDefault();var b=this.parentNode.querySelector(".form-loading"),f=this.parentNode.querySelector(".form-success"),e=this.parentNode.querySelector(".form-error");a={name:this.elements.name.value,
email:this.elements.email.value,phone:this.elements.phone.value,shipping:this.elements.shipping.value,message:this.elements.message.value,cart_sum:this.elements.cartstring.value,cart:cartApi.listCart()};this.classList.add("hide");b.classList.remove("hide");b.classList.add("fade-in");var t=new XMLHttpRequest;t.open("POST","https://notstupidapp.ew.r.appspot.com/shopapi/v2/porolonych");t.onload=function(){if(200<=this.status&&400>this.status){try{yaCounter15918124.reachGoal("order")}catch(q){console.error(q)}console.log("Success");
console.log(this.responseText);b.classList.add("hide");f.classList.remove("hide");f.classList.add("fade-in");cartApi.clearCart();h();u()}else console.log("Server returned error"),b.classList.add("hide"),e.classList.remove("hide"),e.classList.add("fade-in")};t.onerror=function(){console.log("Connection error");b.classList.add("hide");e.classList.remove("hide");e.classList.add("fade-in")};t.send(JSON.stringify(a))},!1)})();